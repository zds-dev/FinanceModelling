...
class ValueHolding(ABC):
    ...
    def generate_timeseries(self, to_datetime, from_datetime,
                            spacing: relativedelta = relativedelta(years=1)):

        time_list = np.array(list(date_range(from_datetime, to_datetime, spacing)))
